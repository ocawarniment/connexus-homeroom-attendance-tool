...
The workflow builds the side panel, validates that the requested version matches the extension files, and publishes a tagged GitHub Release. It intentionally does not create releases for ordinary pushes to `master`.
